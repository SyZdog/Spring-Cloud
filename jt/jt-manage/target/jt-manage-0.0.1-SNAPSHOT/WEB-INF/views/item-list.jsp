...
<script>
	...
	//该函数的作用：动态获取easyUI中选中的数据
    function getSelectionsIds(){
    	var itemList = $("#itemList");
    	//利用easyUI中的方法datagrid动态获取当前选中元素的行（item对象）
		//一般用数组的形式保存数据[item,item,item]
    	...
    	//将数组拼接成串 1,2,3,4,5
    	ids = ids.join(",");//数组的链接符，数组转化为字符串，中间使用逗号分割
    	return ids;
    }
        	...
        	$("#itemEditWindow").window({
        		...
        		onLoad :function(){
        			...
        			$.getJSON('/item/query/item/desc/'+data.id,function(_data){
						//_data是SysResult对象
						//_data.data获取服务器返回值数据信息itemDesc
						//_data.data.itemdesc（页面HTML信息）
        				if(_data.status == 200){
